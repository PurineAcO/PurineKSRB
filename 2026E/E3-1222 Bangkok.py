...
class SunIlluminanceCalculator:
    ...
    def _init_temperature_data(self):
        # 有日照时的温度（24小时）
        data_sun = np.array([
            292.9580871, 293.6496351, 294.3411831, 295.7242790, 296.0671310, 296.2298797,
            296.9665866, 297.9023601, 298.0525309, 298.3259736, 299.0370016, 299.0384629,
            299.0395232, 299.0393997, 299.0372944, 299.0018326, 298.2395085, 298.0514294,
            297.1405913, 296.4498518, 296.2295163, 295.7878215, 294.9328638, 294.0779062
        ])
        self.data_sun_celsius = data_sun - 273.0  # 转℃
        
        # 无日照时的温度（24小时）
        data_no_sun = np.array([
            293.6813207, 294.0500000, 294.3900000, 294.6300000, 295.4100000, 295.8350000,
            296.2600000, 296.4243528, 297.1059155, 297.8039807, 297.8082727, 297.8084182,
            297.8067058, 297.7453409, 297.1237429, 296.5021449, 296.2600000, 296.1200000,
            295.6800000, 295.2400000, 294.8200000, 294.4000000, 294.1700000, 293.7400000
        ])
...
class GeneticAlgorithmOptimizer:
    def __init__(self, calculator, target_date, H=6.0):
        ...
        self.l_min, self.l_max = 0.45,0.5
